...
struct sbi_clk duowen_clks[] = {
	...
	SBI_CLK_INIT(soc_clk2),
	SBI_CLK_INIT(sysfab_clk2),
	SBI_CLK_INIT(cohfab_clk2),
	SBI_CLK_INIT(cluster0_clk2),
	SBI_CLK_INIT(cluster1_clk2),
	SBI_CLK_INIT(cluster2_clk2),
	SBI_CLK_INIT(cluster3_clk2),
	SBI_CLK_INIT(dma_clk2),
	SBI_CLK_INIT(tmr0_clk2),
	SBI_CLK_INIT(tmr1_clk2),
	SBI_CLK_INIT(tmr2_clk2),
	SBI_CLK_INIT(wdt0_clk2),
	SBI_CLK_INIT(wdt1_clk2),
	SBI_CLK_INIT(tlmm_clk2),
	SBI_CLK_INIT(gpio0_clk2),
	SBI_CLK_INIT(gpio1_clk2),
	SBI_CLK_INIT(gpio2_clk2),
	SBI_CLK_INIT(uart0_clk2),
	SBI_CLK_INIT(uart1_clk2),
	SBI_CLK_INIT(uart2_clk2),
	SBI_CLK_INIT(uart3_clk2),
	SBI_CLK_INIT(i2c0_clk2),
	SBI_CLK_INIT(i2c1_clk2),
	SBI_CLK_INIT(i2c2_clk2),
	SBI_CLK_INIT(i2c3_clk2),
	SBI_CLK_INIT(i2c4_clk2),
	SBI_CLK_INIT(i2c5_clk2),
	SBI_CLK_INIT(i2c6_clk2),
	SBI_CLK_INIT(i2c7_clk2),
	SBI_CLK_INIT(i2c8_clk2),
	SBI_CLK_INIT(i2c9_clk2),
	SBI_CLK_INIT(i2c10_clk2),
	SBI_CLK_INIT(i2c11_clk2),
	SBI_CLK_INIT(spi0_clk2),
	SBI_CLK_INIT(spi1_clk2),
	SBI_CLK_INIT(spi2_clk2),
	SBI_CLK_INIT(spi3_clk2),
	SBI_CLK_INIT(spi4_clk2),
	SBI_CLK_INIT(sd_clk2),
	SBI_CLK_INIT(tsensor_clk2),
	SBI_CLK_INIT(pcie_pclk2),
	SBI_CLK_INIT(pcie_aclk2),
	SBI_CLK_INIT(pcie_aux_clk2),
	SBI_CLK_INIT(pcie_alt_ref_clk2),
	SBI_CLK_INIT(eth_alt_ref_clk2),
	SBI_CLK_INIT(sgmii_ref_clk2),
